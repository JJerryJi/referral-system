...
from .views import get_all_alumni, get_one_alumni_details, get_all_student, get_one_student_details, update_alumni
...
urlpatterns = [
    ...
    path('api/alumni/<int:alumni_id>/', update_alumni, name='update_alumni'),
